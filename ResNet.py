...
def Backbone_ResNet50_in3(pretrained=False):
    if pretrained:
...
if __name__ == "__main__":
    div_2, div_4, div_8, div_16, div_32 = Backbone_ResNet101_in1()
    indata = torch.rand(4, 1, 256, 256)
    indata = div_2(indata)
    print(indata.shape)
    indata = div_4(indata)
    print(indata.shape)
    indata = div_8(indata)
    print(indata.shape)
    indata = div_16(indata)
    print(indata.shape)
    indata = div_32(indata)
    print(indata.shape)
